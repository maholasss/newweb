...
// page: tiene página propia (/marcas/<slug> y /en/brands/<slug>)
...
export const BRANDS = [
  ...
  {
    slug: 'shein', name: 'SHEIN', cat: 'fashion', page: true, d: [21.1, 12.0],
  ...
  {
    slug: 'mugler', name: 'Mugler', cat: 'fragrance', page: true, d: [11.8, 9.2],
  ...
  {
    slug: 'kiehls', name: "Kiehl's", cat: 'skincare', d: [25.2],
  ...
  {
    slug: 'cosrx', name: 'COSRX', cat: 'skincare', d: [22.8, 10.0],
  ...
  {
    slug: 'lancome', name: 'Lancôme', cat: 'makeup', d: [14.2],
  ...
  {
    slug: 'nyx', name: 'NYX', cat: 'makeup', d: [18.6],
  ...
  {
    slug: 'essie', name: 'Essie', cat: 'makeup', d: [13.1],
  ...
  {
    slug: 'azzaro', name: 'Azzaro', cat: 'fragrance', d: [29.6],
  ...
  {
    slug: 'cacharel', name: 'Cacharel', cat: 'fragrance', d: [14.1],
    es: { t: 'Yummy Flower Mist', p: 'Bruma de vainilla en un vídeo dulce y rápido.' },
    en: { t: 'Yummy Flower Mist', p: 'A vanilla body mist in a sweet, quick video.' },
  },
  {
    slug: 'pantene', name: 'Pantene', cat: 'hair', d: [21.2],
  ...
  {
    slug: 'tresemme', name: 'TRESemmé', cat: 'hair', d: [9.0],
  ...
  {
    slug: 'nyk1', name: 'NYK1', cat: 'hair', d: [10.4],
  ...
  {
    slug: 'esgir', name: 'Esgir', cat: 'lifestyle', d: [26.4],
  ...
  {
    slug: 'glocolens', name: 'Glocolens', cat: 'makeup', d: [18.4],
  ...
  {
    slug: 'cossy-island', name: 'Cossy Island', cat: 'fashion', d: [10.3],
  ...
  {
    slug: 'mooslover', name: 'Moonslover', cat: 'fashion', d: [12.0, 15.6],
  ...
  {
    slug: 'prozis', name: 'Prozis', cat: 'fashion', d: [56.3],
  ...
  {
    slug: 'temu', name: 'Temu', cat: 'lifestyle', d: [27.4, 45.9, 36.8],
  ...
  {
    slug: 'meoki', name: 'Meoki', cat: 'lifestyle', d: [13.9, 39.2],
...
export const FEATURED = ['cerave', 'loreal-paris', 'shein', 'mugler', 'vichy', 'garnier'];
