...
// cat: skincare | makeup | fragrance | hair | fashion | fitness | lifestyle
...
export const BRANDS = [
  {
    ...
    es: { t: 'Huda Beauty, en rosa de arriba abajo', p: 'Pieza con dirección visual: escenario rosa, vestuario a juego, el logo detrás y la marca convertida en personaje. Expresión, actitud y estilismo al servicio de un universo, no solo de un producto.' },
    en: { t: 'Huda Beauty, pink from top to bottom', p: 'A piece with real art direction: a pink set, matching wardrobe, the logo behind and the brand turned into a character. Expression, attitude and styling serving a whole universe, not just a product.' },
  },
  {
  ...
  {
    slug: 'prozis', name: 'Prozis', cat: 'fitness', page: true, d: [56.3],
    es: { t: 'Ropa deportiva, try-on', p: 'Conjuntos de entreno probados en casa, con movimiento: cómo sientan y cómo aguantan.' },
    en: { t: 'Activewear try-on', p: 'Training sets tried on at home, in motion: how they fit and how they hold up.' },
  },
  {
